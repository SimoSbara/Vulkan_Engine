        ...
        date >> /tmp/VULKAN_UNINSTALL.log
            ...
            echo "Removing /usr/local/lib/libvulkan.1.2.162.dylib" | tee -a /tmp/VULKAN_UNINSTALL.log
            rm -rf /usr/local/lib/libvulkan.1.2.162.dylib
            ...
            echo "Removing /usr/local/lib/libspirv-cross-c-shared.0.44.0.dylib" | tee -a /tmp/VULKAN_UNINSTALL.log
            rm -rf /usr/local/lib/libspirv-cross-c-shared.0.44.0.dylib
